...
//            for (int enemyIndex = 0; enemyIndex < enemyCount; enemyIndex++) //Enemies
//            {
//                EnemyList.Add(new Enemy(enemySprite, new Transform(enemyTransform.Position + enemySpacing, Vector2.Zero, 0f, 1f), EnemyProjectileList));
//            }

//            for (int barrierIndex = 0; barrierIndex < barrierCount; barrierIndex++)
//            {
//                BarrierList.Add(new Barrier(barrierSprite, new Transform(barrierTransform.Position + barrierSpacing, Vector2.Zero, 0f, 1f)));
//            }
//        }
